...
set_property PACKAGE_PIN E3 [get_ports M_CLKtop]							
	set_property IOSTANDARD LVCMOS33 [get_ports M_CLKtop]
	create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports M_CLKtop]
