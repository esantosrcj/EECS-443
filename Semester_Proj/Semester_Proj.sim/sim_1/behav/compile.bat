...
xelab -m64 --debug typical --relax -L xil_defaultlib -L secureip --snapshot Sim_behav --prj H:/School/Spring2015/EECS443/semester/Semester_Proj/Semester_Proj.sim/sim_1/behav/Sim.prj   xil_defaultlib.Sim
if errorlevel 1 (
