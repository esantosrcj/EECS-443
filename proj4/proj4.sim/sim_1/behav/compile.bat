...
xelab -m64 --debug typical --relax -L xil_defaultlib -L secureip --snapshot test_behav --prj H:/School/Spring2015/EECS443/project_4/proj4/proj4.sim/sim_1/behav/test.prj   xil_defaultlib.test
if errorlevel 1 (
